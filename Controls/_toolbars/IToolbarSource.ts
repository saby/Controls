 ...
 * @property {Boolean} [item.readOnly] Определяет, может ли пользователь изменить значение контрола. См. {@link UICore/Base:Control#readOnly подробнее}.
 ...
 * @property {Controls/_toolbars/IToolbarSource/ShowType.typedef} [item.showType] Определяет, где будет отображаться элемент. Значение берется из класса {@link Controls/toolbars:showType}.
 ...
 * @property {Controls/_toolbars/IToolbarSource/ShowType.typedef} [item.showType] Determines where item is displayed. The value is taken from the util 'Controls/Utils/Toolbar'. {@link Controls/toolbars:showType}.
