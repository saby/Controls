...
import GridSpaceAfterBodyRow from '../GridSpaceAfterBodyRow';
...
export default abstract class Grid<S, T extends GridRowMixin<S>> {
    ...
    protected _spaceAfterBodyIsVisible(options: IOptions): boolean {
	...
	protected _initializeSpaceAfterBody(options: IOptions): GridSpaceAfterBodyRow<S> {
...
Object.assign(Grid.prototype, {
    ...
    _$_needitemActionsPaddingCell: false
});
