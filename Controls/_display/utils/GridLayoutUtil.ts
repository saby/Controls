...
const VALID_GRID_COLUMN_WIDTH_VALUE = new RegExp(/^((\d+px)|(\d+%)|([1-9][0-9]*fr)|(auto|min-content|max-content)|(minmax\(((\d+px)|(\d+%)|([1-9][0-9]*fr)|(auto|min-content|max-content)),\s?(((\d+px)|(\d+%)|([1-9][0-9]*fr)|(auto|min-content|max-content)))\)))$/);
