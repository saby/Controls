define("Controls/Application/Core", ["require", "exports", "tslib", "UI/Base", "wml!Controls/Application/Core", "Application/Env", "UI/theme/controller", "Controls/Application/HeadData"], function (require, exports, tslib_1, Base_1, template, Env_1, controller_1, HeadData) {
    "use strict";
    return /** @class */ (function (_super) {
        ...
        function Core(cfg) {
            ...
            Base_1.AppData.initAppData(cfg);
            _this.ctxData = new Base_1.AppData.getAppData();
        ...
        Core.prototype.changeApplicationHandler = function (e, app) {
            ...
            if (this._application !== app) {
                ...
                headData === null || headData === void 0 ? void 0 : headData.resetRenderDeferred();
                this._forceUpdate();
                result = true;
            }
            else {
