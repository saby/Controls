define("Controls/Application", ["require", "exports", "tslib", "UI/Base", "wml!Controls/Application/Page", "Application/Page", "Core/BodyClasses", "Core/helpers/getResourceUrl", "Core/TimeTesterInv", "Env/Env", "Env/Touch", "Env/Event", "Vdom/Vdom", "UI/HotKeys", "Controls/Application/SettingsController", "Controls/popup", "Controls/context", "Controls/event", "Controls/dragnDrop", "css!Controls/Application/oldCss", "css!Controls/application", "css!Controls/dragnDrop", "css!Controls/CommonClasses"], function (require, exports, tslib_1, Base_1, template, Page_1, cBodyClasses, getResourceUrl, TimeTesterInv_1, Env_1, Touch_1, Event_1, Vdom_1, HotKeys_1, SettingsController_1, popup_1, context_1, event_1, dragnDrop_1) {
    "use strict";
    ...
    var Application = /** @class */ (function (_super) {
        ...
        Application.prototype._beforeMount = function (options) {
            ...
            var appData = Base_1.AppData.getAppData();
        ...
        Application._addHeadLinks = function (modules, cfg) {
            ...
            var pls = new Base_1.PrefetchLinksStore();
            if (cfg.prefetch) {
