...
export default class EditingRow extends Control {
    ...
    protected _stopMouseEvent(e, eventName): void {
        /**
         * Останавливаем всплытие любых кликов, если строка редактируется. Если клики будут всплывать,
         * то их будет ловить список и генерировать событие itemClick, которое не должно стрелять на
         ...
         * - Другие компоненты (например, TouchDetector) могут следить за кликами на поле ввода,
         *   т.е. безусловный stopPropagation сломал бы ту логику.
         */
        // e.stopPropagation();
