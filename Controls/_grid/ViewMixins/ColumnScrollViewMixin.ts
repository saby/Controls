...
const ERROR_MESSAGES = {
    MISSING_HEADER: 'Шапку надел?',
    TOO_FREEZE: 'Too cold',
    NEEDLESS_CONTROLLER_ALREADY_EXISTS: 'Что то пошло не так, возможно гонки или ошибка в миксине. ' +
        'Горизонтальный скролл только включили, а контроллер уже создан.',
    CALLED_POSITION_CHANGE_HANDLER: 'Called handler that should not be called while column scroll is not visible.'
};
