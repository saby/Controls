...
describe('Controls/_treeGrid/display/TreeGridFooterCell', () => {
   ...
   it ('.getWrapperClasses()', () => {
      ...
      CssClassesAssert.isSame(footerCell.getWrapperClasses('default'), 'controls-Grid__cell_spacingFirstCol_default controls-Grid__cell_spacingRight controls-GridView__footer__cell controls-TreeGridView__footer__expanderPadding-default');
   });
});
