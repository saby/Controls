...
describe('Controls/_display/TreeItem', () => {
    ...
    describe('expander', () => {
        ...
        it('.getExpanderPaddingClasses()', () => {
            ...
            CssClassesAssert.isSame(item.getExpanderPaddingClasses(), 'controls-TreeGrid__row-expanderPadding controls-TreeGrid__row-expanderPadding controls-TreeGrid__row-expanderPadding_size_default js-controls-ListView__notEditable');

            owner.getExpanderSize = () => 's';
            CssClassesAssert.isSame(item.getExpanderPaddingClasses(), 'controls-TreeGrid__row-expanderPadding controls-TreeGrid__row-expanderPadding controls-TreeGrid__row-expanderPadding_size_s js-controls-ListView__notEditable');

            CssClassesAssert.isSame(item.getExpanderPaddingClasses('xl'), 'controls-TreeGrid__row-expanderPadding controls-TreeGrid__row-expanderPadding controls-TreeGrid__row-expanderPadding_size_xl js-controls-ListView__notEditable');
