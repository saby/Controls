...
define([
   ...
   describe('Controls.List.BaseControl', function() {
      ...
      describe('Update ItemActions in beforeUpdate hook', function() {
         ...
         // при смене значения свойства readOnly необходимо делать переинициализацию ItemActions
         ...
         // при смене значения свойства itemActionsPosition необходимо делать переинициализацию ItemActions
