...
export default class extends Control {
    ...
    private _isSettingsOppened: boolean = true;
    private _panelStyle: string = 'left: calc(100% - 640px); overflow: hidden scroll;';
    private _settingsButtonStyle: string = 'left: 0px;';
    ...
    private _dragScroll: boolean = undefined;
    ...
    protected _toggleSettingsPanel() {
        this._isSettingsOppened = !this._isSettingsOppened;
        if (this._isSettingsOppened) {
            this._settingsButtonStyle = 'left: 0px';
            this._panelStyle = 'left: calc(100% - 640px); overflow: hidden scroll;';
        } else {
            this._settingsButtonStyle = 'left: -125px';
            this._panelStyle = 'left: 100%;';
        }
    }
    ...
    protected _toggleDragScrollScroll(e, value) {
        if (this._dragScroll !== value) {
            this._dragScroll = value;
        }
    }
