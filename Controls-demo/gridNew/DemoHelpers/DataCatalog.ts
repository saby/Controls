...
const getTasksWithHkeydenGroup = () => {
    return {
        getData: (): keyata[] => [
            {
                key: 1,
...
interface keyataForChangeSource {
    key: number;
    load: string | number;
    title: string;
}
...
interface IChangeSource {
    data: keyataForChangeSource[];
    data2: keyataForChangeSource[];
}
...
const countries: string[] = ["Afghanistan","Albania","Algeria","Andorra","Angola","Anguilla","Antigua &amp; Barbuda","Argentina","Armenia","Aruba","Australia","Austria","Azerbaijan","Bahamas"
    ...
    ,"Suriname","Swaziland","Sweden","Switzerland","Syria","Taiwan","Tajikistan","Tanzania","Thailand","Timor L'Este","Togo","Tonga","Trinkeyad &amp; Tobago","Tunisia"
